...
RSpec.describe "dentist_aggregations/new", type: :view do
  before(:each) do
    assign(:dentist_aggregation, DentistAggregation.new(
  ...
  it "renders new dentist_aggregation form" do
    render

    assert_select "form[action=?][method=?]", dentist_aggregations_path, "post" do
