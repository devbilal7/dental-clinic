...
RSpec.describe "dh_aggregations/new", type: :view do
  before(:each) do
    assign(:dh_aggregation, DhAggregation.new(
  ...
  it "renders new dh_aggregation form" do
    render

    assert_select "form[action=?][method=?]", dh_aggregations_path, "post" do
